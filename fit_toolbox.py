...
class Fit():
    ...
    def __init__(
            self,
            ydata: Union[xr.DataArray, np.ndarray] = None,
            *,
            xvals: Optional[Union[xr.DataArray, np.ndarray]] = None,
            fit: bool = True,
            print: bool = False,
        ...
        if ydata is not None:
            ...
            if xvals is None:
                assert isinstance(ydata, xr.DataArray), 'Please provide xvals'
    ...
    def get_parameters(self, xvals, ydata, initial_parameters=None,
        ...
        if isinstance(xvals, xr.DataArray):
            xvals = xvals.ndarray
        elif not isinstance(xvals, np.ndarray):
            xvals = np.array(xvals)
        if isinstance(ydata, xr.DataArray):
            ydata = ydata.ndarray
